...
INSERT INTO Difficulty(DifficultyID,Level) 
...
INSERT INTO Recipe(RecipeID,Name,Description,Instructions,PrepTime,DifficultyID) 
VALUES
...
(2,'Caffè Latte','How to make Caffè Latte? Caffè Latte is a popular espresso based drink that combines espresso and warm milk.',
    'STEP 1: Prepare the espresso. 
    STEP 2: Pour milk to the pitcher. Make sure your stea wand cloth is moist.
    STEP 3: Purge the steam wand and pull it to far up and straight position. Place the pitcher so that the nozzle is aligned to the steam wand. Make sure the steam wand nozzle is in the middle of the pitcher and just below the milk surface. Tilt the pitcher a bit to optimize the whilrpool later on.
    STEP 4: Swith on the steam wand. Start with the nozzle just below the surface but after a second or two rise the pitcher a bit so that the nozzle gets deeper into milk. Make sure the nozzle does not touch the bottom of the pitcher!
    STEP 5: Find a perfect position where the whilrpool of milk is created. Keep warming the milk until it reaches +55-62 c. 
    STEP 6: Swirl the milk in the pitcher until it is smooth, silky and shiny.
    STEP 7: Pour the caffe latte and enjoy!',7,4),
(3,'Mint Chocolate Mocha','erfect coffee recipe for dessert - tune your Café Mocha with mint and chocolate!',
    'Measure syrup into a glass (300 ml). 
    Prepare the espresso on top. 
    Pour steamed milk into the glass. 
    Garnish with whipped cream and cookie crumble.',5,5),
(4,'French Press','Rich flavors in a cup',
    'STEP 1: Measure and grind coffee. 
    STEP 2: Warm up the french press with hot water. Use the water afterwards to water your houseplants.
    STEP 3: Add the ground coffee to the decanter. 
    STEP 4: Pour water on the ground coffee and swirl with spoon. 
    STEP 5: Place the plunger in upper position on top of the decanter and let the coffee steep for 4 min. 
    STEP 6: Press the plunger down. Enjoy!',15,3),
(5,'Cappuccino','How to make Cappuccino? Cappuccino is one of the most popular espresso based drinks. It combines espresso and warm, steamed milk.',
    'STEP 1: Prepare the espresso.STEP 2Pour milk to the pitcher.
    STEP 3: Make sure your steam wand cloth is moist. Purge the steam wand and pull it to far up and straight position. Place the pitcher so that the nozzle is aligned to the steam wand. Make sure the steam wand nozzle is in the middle of the pitcher and just below the milk surface. Tilt the pitcher a bit to optimize the whilrpool later on.   
    STEP 4: Switch on the steam wand. Create froth for the first couple of second (up until the milk has reached 37 c). While froth is created, the volume of the milk increases so be sure to have the steam wand nozzle close to the milk surface all the way through. The longer you keep the nozzle close to milk surface the more froth you will create.   
    ...
    STEP 5: Swirl the milk in the pitcher until it is smooth, silky and shiny.
    STEP 6: Pour the cappuccino and enjoy!',10,4),
(6,'Cold Brew Coffee','Learn how to make cold brew coffee by using Toddy. How to video & instruction how to prepare the coolest coffee drink!',
    'Put the rubber plug in place so it can be removed from the outside. Moisten the reusable filter and place it at the bottom of the filter container. Place the filter bag inside the container.
    Measure 300 g of coarsely ground coffee in the paper filter. Add 2 litres of water in a calm, circular motion.Tie the paper filter with a string. Cover the container and allow to brew for 14–16 hours in the fridge.
    Remove the plug from the bottom of the filter container and pour the extract in a jug. 
    Keep the extract in the fridge in a container tightly closed with a lid (it will keep for about a week in the cold).',16,3),
(7,'Espresso','How to make espresso?',
    'STEP 1: Wipe the portafilter with a clean, dry cloth.
    STEP 2: Dose the coffee grounds into the portafilter.
    STEP 3: Level the dose and tamp it evenly.
    STEP 4: Flush the group head.
    STEP 5: Attach the portafilter and immediately start the brewing.
    STEP 6: Place the cups below the portafilter spouts. Enjoy!',5,2);


INSERT INTO Coffee(CoffeeID,Name,Description,RecipeID,Rating) 
VALUES
...
INSERT INTO CoffeeTag(CoffeeID,TagID,Value) 
VALUES
 (1,1,0)
,(1,5,0)
,(1,15,0)
...
INSERT INTO RecipeIngredient(RecipeID,IngredientID,Quantity,UnitID) 
VALUES
 (1,1,'100',7)
,(1,2,'250',2)
,(2,1,'100',7)
